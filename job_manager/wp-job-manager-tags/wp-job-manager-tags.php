 ...
 */
// class WP_Job_Manager_Job_Tags extends WPJM_Updater {
class WP_Job_Manager_Job_Tags extends WP_Job_Manager {

	/**
	 * __construct function.
	 */
	public function __construct() {
		define( 'JOB_MANAGER_TAGS_VERSION', '1.3.8' );
		define( 'JOB_MANAGER_TAGS_PLUGIN_URL', untrailingslashit( get_stylesheet_directory_uri()."/job_manager/wp-job-manager-tags/" , basename( __FILE__ ) ) );
