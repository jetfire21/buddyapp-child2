...
add_action( 'xprofile_profile_field_data_updated','a21_just_test1');
function a21_just_test1(){
	...
	if( $xprofile_group_id ==bp_get_current_profile_group_id() ) {
		if(!empty($_POST)){
			...
			foreach ($_POST['data'] as $v) {
				// echo $v['timel_id']." ";
				$post_title .= "WHEN ".$v['timel_id']." THEN '".$v['timel_title']."' ";
				$post_content .= "WHEN ".$v['timel_id']." THEN '".$v['timel_content']."' ";
				$post_date .= "WHEN ".$v['timel_id']." THEN '".$v['timel_date']."' ";
			}
			// echo $post_title;
