            ...
            <div class="timeliner_element" style="float: none;">\
                ...
                <div class="content">\
                    <div class="form-group">\
                        ...
                        <div class="col-sm-9">\
                            <input type="text" placeholder="Add Date" name="date" class="form-control datepicker" required="required" data-date-format="dd M yyyy">\
                        </div>\
                    </div>\
                    <div class="form-group">\
                        <label class="col-sm-2 control-label" for="form-field-1"> Title </label>\
                        <div class="col-sm-9">\
                            <input type="text" placeholder="Event Title" name="title" class="form-control" required="required">\
                            <input type="hidden" placeholder="Event Title" name="id_alex" class="form-control" required="required">\
                        </div>\
                    </div>\
                    <div class="form-group">\
