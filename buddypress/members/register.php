...
<div id="buddypress" class="kleo-login-wrap">
	<div class="login-shadow-wrapper">

		<div class="before-login-form-wrapper"><?php
		...
		<div class="login-create-account-wrapper">
			<div class="kleo-register-link">
				...
				<div class="fb-or-section">
					<span><?php echo __("or", "buddyapp");?></span>
				</div>
			</div>
		</div>

		<div class="page login-form-wrapper" id="register-page">

			<p class="register-info"><?php _e( 'Registering for this site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'buddypress' ); ?></p><!--TODO de mutat-->
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<input type="submit" name="signup_submit" id="signup_submit" class="btn btn-lg btn-default btn-block login-button" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
